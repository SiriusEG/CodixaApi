    ...
    public partial class creatingdbmig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionTests", x => x.SectionTestId);
                    table.ForeignKey(
                        name: "FK_SectionTests_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "SectionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_SectionTests_SectionTestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestResults_SectionTests_SectionTestId",
                        column: x => x.SectionTestId,
                        principalTable: "SectionTests",
                        principalColumn: "SectionTestId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ChoicesQuestionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChoicesQuestionText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsTrue = table.Column<bool>(type: "bit", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChoicesQuestions", x => x.ChoicesQuestionId);
                    table.ForeignKey(
                        name: "FK_ChoicesQuestions_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    SelectedChoicesQuestionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswers", x => x.UserAnswerId);
                    table.ForeignKey(
                        name: "FK_UserAnswers_ChoicesQuestions_SelectedChoicesQuestionId",
                        column: x => x.SelectedChoicesQuestionId,
                        principalTable: "ChoicesQuestions",
                        principalColumn: "ChoicesQuestionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserAnswers_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certifications_TestResultId",
                table: "Certifications",
                column: "TestResultId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChoicesQuestions_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_SectionTestId",
                table: "Questions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SectionTests_SectionId",
                table: "SectionTests",
                column: "SectionId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestResults_SectionTestId",
                table: "TestResults",
                column: "SectionTestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_SelectedChoicesQuestionId",
                table: "UserAnswers",
                column: "SelectedChoicesQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_StudentId",
                table: "UserAnswers",
                column: "StudentId");
        }
